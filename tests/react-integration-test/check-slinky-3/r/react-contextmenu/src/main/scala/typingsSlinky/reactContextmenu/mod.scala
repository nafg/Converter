...
object mod {
  ...
  object ContextMenuProps {
    ...
    extension [Self <: ContextMenuProps](x: Self) {
      ...
      inline def setOnHide(value: /* event */ Any => Unit): Self = StObject.set(x, "onHide", js.Any.fromFunction1(value))
      ...
      inline def setOnShow(value: /* event */ Any => Unit): Self = StObject.set(x, "onShow", js.Any.fromFunction1(value))
